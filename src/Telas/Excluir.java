...
ConectaBanco conexao = new ConectaBanco();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("INFORME O NUMERO DA FA:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         Fa.setFa(jTextField1.getText());
          if (jTextField1.getText().isEmpty()) { 
            JOptionPane.showMessageDialog(null,"O campo nao pode esta vazio");
        } 
        else { 
// instanciando a classe UsuarioDAO do pacote dao e criando seu objeto dao 
              Dao.FaDao dao = new Dao.FaDao();
              dao.excluir(Fa);
             JOptionPane.showMessageDialog(null, "Fa -  "+jTextField1.getText()+" -  Excluido com sucesso! ");
              preencherTabela("select * from fa_1");
              jTextField1.setText("");
 ...
 public void preencherTabela(String SQL){
    ...
    String[] Colunas = new String[]{"CODIGO","FA","NOME","DATA","TECNICO","HORA","OBSERVAÇÃO"};
